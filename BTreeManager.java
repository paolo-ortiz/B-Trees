...
//-------------------------------------------------------------------------------------
	...
	public static void insertToNode(long key, int index, long nodeIndex) throws IOException {
		...
		if (key < currentValues[2]) {
			...
			//else go to child node
				...
				insertToNode(key, index, currentValues[1]);
		}
		...
		//else if key to be inserted is greater than 1st key
			...
			//else go to child node
				...
				insertToNode(key, index, currentValues[4]);
		}
		...
		//else if key to be inserted is greater than 2nd key
			...
			//else go to child node
				...
				insertToNode(key, index, currentValues[7]);
		}
		...
		//else if key to be inserted is greater than 3rd key
			...
			//else go to child node
				...
				insertToNode(key, index, currentValues[10]);
		}
		...
		//else if key to be inserted is greater than 4th key
			...
			//else go to child node
				...
				insertToNode(key, index, currentValues[13]);
		}
